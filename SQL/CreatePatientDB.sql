...
/****** Object:  Database [Patient]    Script Date: 27/08/2020 14:46:14 ******/
CREATE DATABASE [Patient]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Patient', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\Patient.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Patient_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\Patient_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [Patient] SET QUERY_STORE = OFF
GO
